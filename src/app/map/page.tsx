...
export default function MapPage() {
  ...
  return (
    <div className="max-w-7xl mx-auto p-5">
      ...
      <div className="relative h-[600px] w-full rounded-lg overflow-hidden shadow-lg mb-6">
      ...
      <div className="bg-gray-50 p-5 rounded-lg shadow">
        ...
        <ul className="list-disc pl-5 space-y-2">
          ...
          <li className="text-gray-700">Click on markers to see information</li>
          <li className="text-gray-700">Drag to pan around the map</li>
          <li className="text-gray-700">
            The blue circle represents a 500m radius area
          </li>
        </ul>
      </div>
    </div>
