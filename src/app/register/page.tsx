...
export default function RegisterCard() {
  ...
  return (
    <div className="w-full max-w-md mt-8 mx-auto rounded-xl border p-6 shadow-md space-y-6 bg-white dark:bg-zinc-900">
      <div className="flex flex-col items-center gap-2">
        ...
        <div className="text-center">
          ...
          <p className="text-sm text-muted-foreground">{t("Login.Details")}</p>
        </div>
      </div>
