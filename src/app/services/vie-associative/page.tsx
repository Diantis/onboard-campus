      ...
      <div className="w-full my-8 px-4 md:px-7 lg:px-12 pb-24">
        ...
        >
          <div
            className="
              ...
              shadow-lg min-h-[180px] bg-[#FF637E] text-white
              w-full md:w-56
            "
          >
            <FaHandshake size={68} />
        ...
        <article className="max-w-3xl mx-auto">
          ...
          <section className="space-y-4">
            <div>
              <h2 className="text-2xl font-semibold text-[#FF637E] mb-3 mt-6">
                Introduction
              </h2>
            ...
            <div>
              ...
              <blockquote className="border-l-4 border-[#FF637E] pl-4 py-3 my-5 italic text-gray-600 dark:text-gray-400 bg-pink-50 dark:bg-pink-950/50 rounded-r-md">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit.
              </blockquote>
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit.
