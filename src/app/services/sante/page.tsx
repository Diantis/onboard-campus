      ...
      <div className="w-full my-8 px-4 md:px-7 lg:px-12 pb-24">
        ...
        >
          <div
            className="
              ...
              shadow-lg min-h-[180px] bg-[#FF8904] text-white
              w-full md:w-56
            "
          >
            <BiHealth size={68} />
            <h2 className="text-white font-semibold text-lg mt-3">Santé</h2>
          </div>
          <div
            className="
        ...
        <article className="max-w-3xl mx-auto">
          ...
          <section className="space-y-4">
            <div>
              <h2 className="text-2xl font-semibold text-[#FF8904] mb-3 mt-6">
                Introduction
              </h2>
            ...
            <div>
              ...
              <blockquote className="border-l-4 border-[#FF8904] pl-4 py-3 my-5 italic text-gray-600 dark:text-gray-400 bg-orange-50 dark:bg-orange-950/50 rounded-r-md">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit.
              </blockquote>
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit.
