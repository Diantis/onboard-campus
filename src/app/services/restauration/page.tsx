      ...
      <div className="w-full my-8 px-4 md:px-7 lg:px-12 pb-24">
        ...
        >
          <div
            className="
              ...
              shadow-lg min-h-[180px] bg-[#00D492] text-white
              w-full md:w-56
            "
          >
            <IoMdRestaurant size={68} />
        ...
        <article className="max-w-3xl mx-auto">
          <h1 className="text-3xl md:text-4xl font-bold mb-8 text-gray-900 dark:text-gray-100 text-center md:text-left">
            Tout savoir sur la restauration
          </h1>

          <section className="space-y-4">
            <div>
              <h2 className="text-2xl font-semibold text-[#00D492] mb-3 mt-6">
                Introduction
              </h2>
            ...
            <div>
              ...
              <blockquote className="border-l-4 border-[#00D492] pl-4 py-3 my-5 italic text-gray-600 dark:text-gray-400 bg-green-50 dark:bg-green-950/50 rounded-r-md">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit.
              </blockquote>
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit.
